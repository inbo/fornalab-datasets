...
Formats each contributor entry in EML structure, including ORCID if present.
...
Check if columns across the event and occurrence datasets have the expected data types, e.g., verify event dates and numeric columns.
