...
The GBIF Metadata Profile is based on the Ecological Metadata Language (EML).
...
'meta.xml' is a static file describing the Darwin Core Archive structure with the definitions. It is manually adapted for each dataset, and needs to be copied to the export folder.
